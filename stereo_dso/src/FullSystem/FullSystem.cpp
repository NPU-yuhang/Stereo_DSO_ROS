...
void FullSystem::deliverTrackedFrame(FrameHessian* fh, FrameHessian* fh_right, bool needKF)
{
	...
	{
        //std::cout<<"deliverTrackedFrame11111"<<std::endl;
	...
	{
        //std::cout<<"deliverTrackedFrame22222"<<std::endl;
...
void FullSystem::mappingLoop()
{
	...
	while(runMapping)
	{
        ...
        //std::cout<<"unmappedTrackedFrames size: "<<unmappedTrackedFrames.size()<<"---id: "<<fh->frameID<<std::endl;

        unmappedTrackedFrames.pop_front();
        FrameHessian* fh_right = unmappedTrackedFrames_right.front();
        //std::cout<<"unmappedTrackedFrames_right size: "<<unmappedTrackedFrames_right.size()<<"---id: "<<fh_right->frameID<<std::endl;
